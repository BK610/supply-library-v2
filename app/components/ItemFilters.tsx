    ...
    <div className="flex flex-wrap gap-4 mb-8 p-4 bg-white dark:bg-gray-800 shadow-sm outline outline-gray-700 dark:outline-gray-300">
      <div className="flex-1 min-w-[200px]">
        ...
        <select
          ...
          className="w-full cursor-pointer outline outline-gray-300 dark:outline-gray-700 hover:outline-gray-500 dark:hover:outline-gray-400 bg-white dark:bg-gray-700 px-3 py-2 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
