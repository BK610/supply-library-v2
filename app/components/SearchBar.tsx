    ...
    <div className="flex flex-wrap gap-4 mb-8 p-4 bg-white dark:bg-gray-800 shadow-sm outline outline-gray-700 dark:outline-gray-300">
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full px-4 py-2 pl-10 outline dark:outline-gray-700 outline-gray-300 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <svg
