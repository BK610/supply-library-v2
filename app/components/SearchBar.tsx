    ...
    <div className="flex flex-wrap rounded-xs gap-4 mb-6 p-4 bg-white dark:bg-gray-800 shadow-sm outline outline-gray-700 dark:outline-gray-300">
      <div className="relative w-full">
        ...
        <input
          ...
          className="w-full rounded-xs px-4 py-2 pl-10 outline dark:outline-gray-700 outline-gray-400 hover:outline-gray-600 dark:hover:outline-gray-400 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-2 focus:outline-blue-500"
        />
        <svg
